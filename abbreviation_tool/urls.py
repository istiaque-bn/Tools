...
urlpatterns = [
    ...
    path(
        "dictionary/manage/export.xlsx",
        views.export_dictionary_xlsx,
        name="export_dictionary_xlsx",
    ),
    path(
        "dictionary/manage/<int:entry_id>/",
        views.manage_dictionary,
        name="edit_dictionary_entry",
    ),
    path(
        "dictionary/manage/<int:entry_id>/delete/",
        views.delete_dictionary_entry,
    ...
    path(
        "sessions/<uuid:session_id>/suggestions/<uuid:suggestion_id>/",
        views.suggestion_api,
        name="suggestion_api",
    ),
    path(
        "sessions/<uuid:session_id>/suggestions/bulk/",
        views.bulk_review_api,
        name="bulk_review_api",
    ),
    ...
    path(
        "sessions/<uuid:session_id>/glossary/",
        views.glossary_download,
        name="glossary_download",
    ),
]
